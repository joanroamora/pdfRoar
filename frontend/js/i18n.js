...
const translations = {
  en: {
    ...
    subtitle: "Ultra-fast PDF merging, splitting, clean text extraction, Word (.DOCX) converter, WYSIWYG editor, and PDF4QT Native Studio.",
    tab_merge: "Merge Studio",
    tab_split: "Split & Extract Studio",
    tab_totext: "PDF to Text Converter",
    tab_todocx: "PDF to DOCX (Word)",
    tab_editor: "Word/Acrobat Editor",
    tab_pdf4qt: "PDF4QT Native Studio",
    ...
    dropzone_docx_title: "Drag & Drop PDF file to Convert to Word (.DOCX)",
    ...
    btn_todocx: "Convert to Word (.DOCX)",
  ...
  es: {
    ...
    subtitle: "Unión, separación, convertidor a texto, convertidor a Word (.DOCX), editor interactivo y Suite Nativa PDF4QT.",
    tab_merge: "Estudio Unir PDFs",
    tab_split: "Estudio Separar y Extraer",
    tab_totext: "Convertidor PDF a Texto",
    tab_todocx: "PDF a Word (.DOCX)",
    ...
    dropzone_docx_title: "Arrastra y suelta un archivo PDF para Convertir a Word (.DOCX)",
    ...
    btn_todocx: "Convertir a Word (.DOCX)",
  ...
  fr: {
    ...
    subtitle: "Fusion, division, convertisseur texte, convertisseur Word (.DOCX), éditeur interactif et Suite Native PDF4QT.",
    tab_merge: "Studio Fusion PDF",
    tab_split: "Studio Division & Extraction",
    tab_totext: "Convertisseur PDF en Texte",
    tab_todocx: "PDF en Word (.DOCX)",
    ...
    dropzone_docx_title: "Glissez & déposez un fichier PDF pour convertir en Word (.DOCX)",
    ...
    btn_todocx: "Convertir en Word (.DOCX)",
  ...
  de: {
    ...
    subtitle: "Zusammenfügen, Teilen, Konvertierung, Word (.DOCX) Konverter, Word/Acrobat-Editor und PDF4QT Native Suite.",
    tab_merge: "Zusammenfügen Studio",
    tab_split: "Teilen & Extrahieren Studio",
    tab_totext: "PDF-zu-Text Konverter",
    tab_todocx: "PDF zu Word (.DOCX)",
    tab_editor: "Word/Acrobat Editor",
    tab_pdf4qt: "PDF4QT Native Suite",
    ...
    dropzone_docx_title: "PDF-Datei für Word (.DOCX) Konvertierung hierher ziehen",
    ...
    btn_todocx: "In Word (.DOCX) Konvertieren",
